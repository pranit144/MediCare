...
const PDFGenerator = ({name, age, gender, selectedDoc}, prescription) => {
    ...
    pdf.text("Medicare", (pdf.internal.pageSize.width - 40 - (pdf.getStringUnitWidth("Medicare") * pdf.internal.getFontSize())), y);
    y += 30;
    ...
    y += 20;
    pdf.text("medicare@gmail.com", (pdf.internal.pageSize.width - 40 - (pdf.getStringUnitWidth("medicare@gmail.com") * pdf.internal.getFontSize())), y);
    y += 25;
    ...
    pdf.text("2025 @medicare | All Rights Reserved", pdf.internal.pageSize.width - 40 - pdf.getStringUnitWidth("2025 @Medicare | All Rights Reserved") * pdf.internal.getFontSize(), pdf.internal.pageSize.height - 30);
